...
export const JobSchema = z.object({
    ...
    job_requirements: z.union([z.string(), z.array(z.string())]).transform((value) => Array.isArray(value)
        ? value
        : value
            .split(/\n|,|;/g)
            .map((item) => item.trim())
    ...
    job_qualifications: z.union([z.string(), z.array(z.string())]).transform((value) => Array.isArray(value)
        ? value
        : value
            .split(/\n|,|;/g)
            .map((item) => item.trim())
...
//# sourceMappingURL=functionValidations.js.map