...
const getModels = async (req, res) => {
    ...
    const r = await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${env.GOOGLE_API_KEY}`);
...
const getRunsResult = async (req, res) => {
    try {
